...
USE GUCera
insert into Users values ('kewi','Cool','123',convert(bit , '1'  ),'kewi','Cool');
insert into Admin values (1);
select * from users
select * from Course

/*exec studentRegister 'mido3', 'konar','123','mm@mmh.com','1','tahta';
exec InstructorRegister 'slim', 'abdennader', '123','ss@s.som','1','Cairo';
exec DefineAssignmentOfCourseOfCertianType 3,2,1,'exam',70,70,'1/5/2000','good one that hasdjdfkhgdklfhfdkfhgdfhgdfjhlg'



exec InstAddCourse 8, 'CS1002', '1200.50', 3
insert into Users values ('kewi','Cool','123',convert(bit , '1'  ),'kewi','Cool');
insert into Admin values (5003);
exec availableCourses;
exec enrollInCourse 1, 2,3 
exec enrollInCourse 10, 2,3 
exec AdminViewAllCourses

exec viewAssign 2,1
exec InstructorgradeAssignmentOfAStudent 3,1,1,0,'quiz',100
exec InstructorgradeAssignmentOfAStudent 3,1,2,0,'project',100
exec InstructorIssueCertificateToStudent 1,1,3,'1/1/2000'
exec calculateFinalGrade 1, 1, 3
exec calculateFinalGrade 2, 1, 3
exec calculateFinalGrade 2, 1, 3
