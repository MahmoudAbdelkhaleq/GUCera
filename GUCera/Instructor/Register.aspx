<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="GUCera.InstructorRej" %>
...
<body>
    <form id="form1" runat="server">
      <div>
            ...
            <br />
            <asp:Button ID="RegisterInstructor" runat="server" Text="Register" OnClick="RegisterInstructor_Click"  />
            <br />
        </div>
    </form>
</body>
